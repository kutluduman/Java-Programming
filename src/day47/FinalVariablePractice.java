...
public class FinalVariablePractice {
    ...
    public static void main(String[] args) {
        ...
        // can not reassign the value because its final
        //s1 = new Student(102);
        // you can still change the internal data attached to the object
        ...
        //      Student.school="abc"; // it wont compile because it is final
