...
//        Cell(6,1)= 67	Cell(6,2)= 33	Cell(6,3)= 98	Cell(6,4)= 34
        ...
        int[][] sheet = new int[][] { row1, row2, row3, row4, row4, row5, row6};
...
//                              0           1           2
        ...
        System.out.println(myExcel.length); // 3 one dimensional (1d) array object stored in this particular array

            //myExcel is 2d array object
        ...
        for (int x = 0 ; x<myExcel.length ; x++) {
            ...
            System.out.println("Item " + x + " is " +myExcel[x].length);
